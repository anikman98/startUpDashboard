<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <div id="userRole" value='roles' class="form-group {{ $errors->has('roles') ? 'has-error' : ''}}">
    ...
    <div id="companyTable" class="form-group {{ $errors->has('company') ? 'has-error' : ''}}">
            ...
            <div class="col-md-6">
                {!! Form::select('company',App\Company::get()->pluck('name','name'), isset($company)?$company->name:null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required','multiple'] : ['class' => 'form-control','multiple']) !!}
